...
public class Page<T> implements java.io.Serializable {
	...
	private List<T> data = Collections.emptyList();// 业务数据集合
	private int first;
	private int last;
	private int prev;
	private int next;
	...
	/*
	 * public static void main(String args[]) { Page<UniskUser> page = new Page<UniskUser>(); page.setTotalCount(111); page.setCurrentPage(1); System.out.println(page.getTotalPage()); }
	 */
}
